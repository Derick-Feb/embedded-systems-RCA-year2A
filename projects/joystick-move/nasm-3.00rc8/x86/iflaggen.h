...
#define IF_OSIZE             19 /* Unsized operands must match the default operand size             */
...
#define IF_NF_E              33 /* EVEX.NF set with {nf} prefix                                     */
#define IF_ZU                34 /* Instruction supports the {zu} prefix                             */
#define IF_ZU_R              35 /* Instruction requires the {zu} prefix                             */
#define IF_ZU_E              36 /* EVEX.ND set with {zu} prefix                                     */
#define IF_LIG               37 /* Ignore VEX/EVEX L field                                          */
#define IF_WIG               38 /* Ignore VEX/EVEX W field                                          */
#define IF_WW                39 /* VEX/EVEX W is REX.W                                              */
#define IF_SIB               40 /* SIB encoding required                                            */
#define IF_LOCK              41 /* Lockable if operand 0 is memory                                  */
#define IF_LOCK1             42 /* Lockable if operand 1 is memory                                  */
#define IF_NOLONG            43 /* Not available in long mode                                       */
#define IF_LONG              44 /* Long mode                                                        */
#define IF_NOHLE             45 /* HLE prefixes forbidden                                           */
#define IF_MIB               46 /* split base/index EA                                              */
#define IF_BND               47 /* BND (0xF2) prefix available                                      */
#define IF_REX2              48 /* REX2 encoding required                                           */
#define IF_HLE               49 /* HLE prefixed                                                     */
#define IF_FL                50 /* Instruction modifies the flags                                   */
#define IF_MOPVEC            51 /* M operand is a vector                                            */
#define IF_SCC               52 /* EVEX[27:24] is special condition code                            */
#define IF_BESTDIS           53 /* Preferred disassembly pattern                                    */
#define IF_DFV               54 /* Destination flag values                                          */
                                /* 54...63 reserved                                                 */
...
#define IF_AVX512FC16       112 /* AVX-512 FC16 instructions                                        */
...
#define IF_AMXINT8          121 /* AMX 8-bit integer multiplication                                 */
#define IF_FRED             122 /* Flexible Return and Exception Delivery (FRED)                    */
#define IF_RAOINT           123 /* Remote atomic operations (RAO-INT)                               */
#define IF_UINTR            124 /* User interrupts                                                  */
#define IF_CMPCCXADD        125 /* CMPccXADD instructions                                           */
#define IF_PREFETCHI        126 /* PREFETCHI0 and PREFETCHI1                                        */
#define IF_MSRLIST          127 /* RDMSRLIST and WRMSRLIST                                          */
#define IF_AVXNECONVERT     128 /* AVX exceptionless floating-point conversions                     */
#define IF_AVXVNNIINT8      129 /* AVX Vector Neural Network 8-bit integer instructions             */
#define IF_AVXIFMA          130 /* AVX integer multiply and add                                     */
#define IF_HRESET           131 /* History reset                                                    */
#define IF_SMAP             132 /* Supervisor Mode Access Prevention (SMAP)                         */
#define IF_SHA512           133 /* SHA512 instructions                                              */
#define IF_HSM3             134 /* SM3 hash instructions                                            */
#define IF_HSM4             135 /* SM4 hash instructions                                            */
#define IF_APX              136 /* Advanced Performance Extensions (APX)                            */
#define IF_AVX10_1          137 /* AVX 10.1 instructions                                            */
#define IF_AVX10_2          138 /* AVX 10.2 instructions                                            */
#define IF_AVX10_VNNIINT    139 /* AVX Vector Neural Network integer instructions                   */
#define IF_ADX              140 /* ADCX and ADOX instructions                                       */
#define IF_PKU              141 /* Protection key for user mode                                     */
#define IF_MONITOR          142 /* MONITOR and MWAIT                                                */
#define IF_MONITORX         143 /* MONITORX and MWAITX                                              */
#define IF_WAITPKG          144 /* User wait instruction package                                    */
#define IF_INVPCID          145 /* INVPCID instruction                                              */
#define IF_PREFETCHWT1      146 /* PREFETCHWT1 instruction                                          */
#define IF_PCONFIG          147 /* PCONFIG instruction                                              */
#define IF_WBNOINVD         148 /* WBNOINVD instruction                                             */
#define IF_SERIALIZE        149 /* SERIALIZE instruction                                            */
#define IF_LKGS             150 /* LKGS instruction                                                 */
#define IF_WRMSRNS          151 /* WRMSRNS instruction                                              */
#define IF_CLFLUSHOPT       152 /* CLFLUSHOPT instruction                                           */
#define IF_CLWB             153 /* CLWB instruction                                                 */
#define IF_RDRAND           154 /* RDRAND instruction                                               */
#define IF_RDSEED           155 /* RDSEED instruction                                               */
#define IF_RDPID            156 /* RDPID instruction                                                */
#define IF_LZCNT            157 /* LZCNT instruction                                                */
#define IF_PTWRITE          158 /* PTWRITE instruction                                              */
#define IF_CLDEMOTE         159 /* CLDEMOTE instruction                                             */
#define IF_MOVDIRI          160 /* MOVDIRI instruction                                              */
#define IF_MOVDIR64B        161 /* MOVDIR64B instruction                                            */
#define IF_CLZERO           162 /* CLZERO instruction                                               */
#define IF_MOVBE            163 /* MOVBE instruction                                                */
#define IF_MOVRS            164 /* MOVRS instruction                                                */
#define IF_OBSOLETE         165 /* Instruction removed from architecture                            */
#define IF_NEVER            166 /* Instruction never implemented                                    */
#define IF_NOP              167 /* Instruction is always a (nonintentional) NOP                     */
                                /* 167...191 reserved                                               */
...
#define IFM_NF_E            UINT32_C(0x00000002)     /*  33 */
#define IFM_ZU              UINT32_C(0x00000004)     /*  34 */
#define IFM_ZU_R            UINT32_C(0x00000008)     /*  35 */
#define IFM_ZU_E            UINT32_C(0x00000010)     /*  36 */
#define IFM_LIG             UINT32_C(0x00000020)     /*  37 */
#define IFM_WIG             UINT32_C(0x00000040)     /*  38 */
#define IFM_WW              UINT32_C(0x00000080)     /*  39 */
#define IFM_SIB             UINT32_C(0x00000100)     /*  40 */
#define IFM_LOCK            UINT32_C(0x00000200)     /*  41 */
#define IFM_LOCK1           UINT32_C(0x00000400)     /*  42 */
#define IFM_NOLONG          UINT32_C(0x00000800)     /*  43 */
#define IFM_LONG            UINT32_C(0x00001000)     /*  44 */
#define IFM_NOHLE           UINT32_C(0x00002000)     /*  45 */
#define IFM_MIB             UINT32_C(0x00004000)     /*  46 */
#define IFM_BND             UINT32_C(0x00008000)     /*  47 */
#define IFM_REX2            UINT32_C(0x00010000)     /*  48 */
#define IFM_HLE             UINT32_C(0x00020000)     /*  49 */
#define IFM_FL              UINT32_C(0x00040000)     /*  50 */
#define IFM_MOPVEC          UINT32_C(0x00080000)     /*  51 */
#define IFM_SCC             UINT32_C(0x00100000)     /*  52 */
#define IFM_BESTDIS         UINT32_C(0x00200000)     /*  53 */
#define IFM_DFV             UINT32_C(0x00400000)     /*  54 */
...
#define IFM_AVX512FC16      UINT32_C(0x00010000)     /* 112 */
...
#define IFM_AMXINT8         UINT32_C(0x02000000)     /* 121 */
#define IFM_FRED            UINT32_C(0x04000000)     /* 122 */
#define IFM_RAOINT          UINT32_C(0x08000000)     /* 123 */
#define IFM_UINTR           UINT32_C(0x10000000)     /* 124 */
#define IFM_CMPCCXADD       UINT32_C(0x20000000)     /* 125 */
#define IFM_PREFETCHI       UINT32_C(0x40000000)     /* 126 */
#define IFM_MSRLIST         UINT32_C(0x80000000)     /* 127 */
/* Mask bits for field 4 : 128...159 */
#define IFM_AVXNECONVERT    UINT32_C(0x00000001)     /* 128 */
#define IFM_AVXVNNIINT8     UINT32_C(0x00000002)     /* 129 */
#define IFM_AVXIFMA         UINT32_C(0x00000004)     /* 130 */
#define IFM_HRESET          UINT32_C(0x00000008)     /* 131 */
#define IFM_SMAP            UINT32_C(0x00000010)     /* 132 */
#define IFM_SHA512          UINT32_C(0x00000020)     /* 133 */
#define IFM_HSM3            UINT32_C(0x00000040)     /* 134 */
#define IFM_HSM4            UINT32_C(0x00000080)     /* 135 */
#define IFM_APX             UINT32_C(0x00000100)     /* 136 */
#define IFM_AVX10_1         UINT32_C(0x00000200)     /* 137 */
#define IFM_AVX10_2         UINT32_C(0x00000400)     /* 138 */
#define IFM_AVX10_VNNIINT   UINT32_C(0x00000800)     /* 139 */
#define IFM_ADX             UINT32_C(0x00001000)     /* 140 */
#define IFM_PKU             UINT32_C(0x00002000)     /* 141 */
#define IFM_MONITOR         UINT32_C(0x00004000)     /* 142 */
#define IFM_MONITORX        UINT32_C(0x00008000)     /* 143 */
#define IFM_WAITPKG         UINT32_C(0x00010000)     /* 144 */
#define IFM_INVPCID         UINT32_C(0x00020000)     /* 145 */
#define IFM_PREFETCHWT1     UINT32_C(0x00040000)     /* 146 */
#define IFM_PCONFIG         UINT32_C(0x00080000)     /* 147 */
#define IFM_WBNOINVD        UINT32_C(0x00100000)     /* 148 */
#define IFM_SERIALIZE       UINT32_C(0x00200000)     /* 149 */
#define IFM_LKGS            UINT32_C(0x00400000)     /* 150 */
#define IFM_WRMSRNS         UINT32_C(0x00800000)     /* 151 */
#define IFM_CLFLUSHOPT      UINT32_C(0x01000000)     /* 152 */
#define IFM_CLWB            UINT32_C(0x02000000)     /* 153 */
#define IFM_RDRAND          UINT32_C(0x04000000)     /* 154 */
#define IFM_RDSEED          UINT32_C(0x08000000)     /* 155 */
#define IFM_RDPID           UINT32_C(0x10000000)     /* 156 */
#define IFM_LZCNT           UINT32_C(0x20000000)     /* 157 */
#define IFM_PTWRITE         UINT32_C(0x40000000)     /* 158 */
#define IFM_CLDEMOTE        UINT32_C(0x80000000)     /* 159 */
/* Mask bits for field 5 : 160...191 */
#define IFM_MOVDIRI         UINT32_C(0x00000001)     /* 160 */
#define IFM_MOVDIR64B       UINT32_C(0x00000002)     /* 161 */
#define IFM_CLZERO          UINT32_C(0x00000004)     /* 162 */
#define IFM_MOVBE           UINT32_C(0x00000008)     /* 163 */
#define IFM_MOVRS           UINT32_C(0x00000010)     /* 164 */
#define IFM_OBSOLETE        UINT32_C(0x00000020)     /* 165 */
#define IFM_NEVER           UINT32_C(0x00000040)     /* 166 */
#define IFM_NOP             UINT32_C(0x00000080)     /* 167 */
...
extern const iflag_t insns_flags[633];
