...
const char * const warning_name[67] = {
	NULL,
	"db-empty",
	"ea-absolute",
	"ea-dispsize",
...
const struct warning_alias warning_alias[82] = {
	{ "all",                      WARN_IDX_ALL },
...
const char * const warning_help[67] = {
	NULL,
...
const uint8_t warning_default[66] = {
	WARN_INIT_ON,
	WARN_INIT_ON,
	WARN_INIT_ON,
	WARN_INIT_ON,
...
uint8_t warning_state[66];	/* Current state */
